...
export const SlideSection: React.FC = () => {
  const features = [
    { icon: Shield, title: 'Segurança', description: 'Proteção total dos seus dados com criptografia avançada' },
    { icon: Clock, title: 'Agilidade', description: 'Atendimento rápido e eficiente para sua empresa' },
    { icon: Award, title: 'Qualidade', description: 'Serviços certificados com excelência garantida' },
    { icon: Users, title: 'Suporte', description: 'Equipe especializada pronta para ajudar 24/7' },
    { icon: Target, title: 'Resultados', description: 'Metas alcançadas com nossa plataforma' }
  ];
