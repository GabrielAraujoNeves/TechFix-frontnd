      ...
      {filteredUsers.length === 0 ? (
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-black-main/50 border border-gray-700 rounded-lg">
            ...
            <tbody>
              {filteredUsers.map((user) => (
                <tr key={user.id} className="border-b border-gray-700 hover:bg-black-main/30 transition-colors">
